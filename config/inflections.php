 ...
 */
	...
	*/
	...
	$pluralRules = array(
		...
		# # Se palavra termina em "il" e tem acento agudo na última sílaba, troca "il", por "is"
		#cantil - cantis
		'/^([a-zA-Z]*)il$/i' => '\1is',
 
		# # TODO
		#  # Se a palavra termina com "il" e tiver um acento agudo na penultima sílaba, troca "il" por "eis"  
		#  # sem exemplo
 
		// Esse aqui é um pouco mais complicado. Fiquei de fazer, porque não tem como 
		// identificar acentos quando não se usa acentos( nome das tabelas)
		...
		# #TODO  
		#  # Se a palavra termana com "s" e tem uma sílaba, troca "s" por "es" 
		#  #sem exemplo  
		...
		#   
		#  # Se a palavra termina com "ão", Existem 3 jeitos para o prural: ãos, ães, ões
		#  #NOTA: Díficil de achar, Eu usei os casos mais conhecidos 
		#  # e depois usei os casos irregulares (lá embaixo em $irregularPlural) para os outros. Se alguem conhece  
