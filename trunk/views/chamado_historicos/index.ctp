...
<table cellpadding="0" cellspacing="0">
	<tr>
		...
		<th><?php echo $paginator->sort('data_hora_incial');?></th>
		<th><?php echo $paginator->sort('data_hora_final');?></th>
	...
	?>
	<tr <?php echo $class;?>>
		<td><?php echo $chamadoHistorico['ChamadoHistorico']['id']; ?></td>
		<td><?php echo $chamadoHistorico['ChamadoHistorico']['data_hora_incial']; ?>
		</td>
		<td><?php echo $chamadoHistorico['ChamadoHistorico']['data_hora_final']; ?>
		</td>
		<td><?php echo $html->link($chamadoHistorico['Chamado']['id'], array('controller'=> 'chamados', 'action'=>'view', $chamadoHistorico['Chamado']['id'])); ?>
		</td>
		<td><?php echo $html->link($chamadoHistorico['Usuario']['id'], array('controller'=> 'usuarios', 'action'=>'view', $chamadoHistorico['Usuario']['id'])); ?>
		</td>
		<td><?php echo $chamadoHistorico['ChamadoHistorico']['descricao']; ?>
		</td>
		<td class="actions"><?php echo $html->link(__('View', true), array('action'=>'view', $chamadoHistorico['ChamadoHistorico']['id'])); ?>
