...
<table cellpadding="0" cellspacing="0">
	...
	?>
	<tr <?php echo $class;?>>
		<td><?php echo $sla['Sla']['id']; ?></td>
		<td><?php echo $sla['Sla']['tempo']; ?></td>
		<td><?php echo $sla['Sla']['descricao']; ?></td>
		<td class="actions"><?php echo $html->link(__('View', true), array('action'=>'view', $sla['Sla']['id'])); ?>
