...
<?php $i = 0; $class = ' class="altrow"';?>
	...
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $prioridade['Prioridade']['id']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Tempo'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $prioridade['Prioridade']['tempo']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Descricao'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $prioridade['Prioridade']['descricao']; ?>
	&nbsp;</dd>
</dl>
</div>
<div class="actions">
<ul>
	<li><?php echo $html->link(__('Edit Prioridade', true), array('action'=>'edit', $prioridade['Prioridade']['id'])); ?>
	</li>
	<li><?php echo $html->link(__('Delete Prioridade', true), array('action'=>'delete', $prioridade['Prioridade']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $prioridade['Prioridade']['id'])); ?>
	</li>
	<li><?php echo $html->link(__('List Prioridades', true), array('action'=>'index')); ?>
	</li>
	<li><?php echo $html->link(__('New Prioridade', true), array('action'=>'add')); ?>
	</li>
