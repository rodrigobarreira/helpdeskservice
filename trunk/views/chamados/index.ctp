...
<table cellpadding="0" cellspacing="0">
	...
	?>
	<tr <?php echo $class;?>>
		<td><?php echo $chamado['Chamado']['id']; ?></td>
		<td><?php echo $html->link($chamado['Problema']['id'], array('controller'=> 'problemas', 'action'=>'view', $chamado['Problema']['id'])); ?>
		</td>
		<td><?php echo $html->link($chamado['Usuario']['id'], array('controller'=> 'usuarios', 'action'=>'view', $chamado['Usuario']['id'])); ?>
		</td>
		<td><?php echo $chamado['Chamado']['data_hora_abertura']; ?></td>
		<td><?php echo $chamado['Chamado']['aberto_por']; ?></td>
		<td><?php echo $chamado['Chamado']['descricao_problema']; ?></td>
		<td><?php echo $chamado['Chamado']['descricao_solucao']; ?></td>
		<td><?php echo $chamado['Chamado']['data_hora_atendimento']; ?></td>
		<td><?php echo $html->link($chamado['Status']['id'], array('controller'=> 'status', 'action'=>'view', $chamado['Status']['id'])); ?>
		</td>
		<td><?php echo $chamado['Chamado']['data_hora_encerramento']; ?></td>
		<td><?php echo $html->link($chamado['Responsavel']['id'], array('controller'=> 'usuarios', 'action'=>'view', $chamado['Responsavel']['id'])); ?>
		</td>
		<td class="actions"><?php echo $html->link(__('View', true), array('action'=>'view', $chamado['Chamado']['id'])); ?>
