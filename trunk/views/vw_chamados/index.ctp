...
?>
	<tr<?php echo $class;?>>
		<td>
			<?php echo $vwChamado['VwChamado']['id']; ?>
		</td>
		<td>
			<?php echo $vwChamado['VwChamado']['prioridade']; ?>
		</td>
		<td>
			<?php echo $vwChamado['VwChamado']['tempo']; ?>
		</td>
		<td>
			<?php echo $vwChamado['VwChamado']['setor']; ?>
		</td>
		<td>
			<?php echo $vwChamado['VwChamado']['problema']; ?>
		</td>
		<td>
			<?php echo $vwChamado['VwChamado']['titulo']; ?>
		</td>
		<td>
			<?php echo $vwChamado['VwChamado']['responsvel']; ?>
		</td>
		<td>
			<?php echo $vwChamado['VwChamado']['solicitante']; ?>
		</td>
		<td>
			<?php echo $vwChamado['VwChamado']['data_hora_abertura']; ?>
		</td>
		<td>
			<?php echo $vwChamado['VwChamado']['data_hora_limite']; ?>
		</td>
		<td>
			<?php echo $vwChamado['VwChamado']['descricao']; ?>
		</td>
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action'=>'view', $vwChamado['VwChamado']['id'])); ?>
