...
<?php $i = 0; $class = ' class="altrow"';?>
	...
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $problema['Problema']['id']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Descricao'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $problema['Problema']['descricao']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Sla'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $html->link($problema['Sla']['id'], array('controller'=> 'slas', 'action'=>'view', $problema['Sla']['id'])); ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Setor'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $html->link($problema['Setor']['id'], array('controller'=> 'setores', 'action'=>'view', $problema['Setor']['id'])); ?>
	&nbsp;</dd>
</dl>
</div>
<div class="actions">
<ul>
	<li><?php echo $html->link(__('Edit Problema', true), array('action'=>'edit', $problema['Problema']['id'])); ?>
	</li>
	<li><?php echo $html->link(__('Delete Problema', true), array('action'=>'delete', $problema['Problema']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $problema['Problema']['id'])); ?>
	</li>
	<li><?php echo $html->link(__('List Problemas', true), array('action'=>'index')); ?>
	</li>
	<li><?php echo $html->link(__('New Problema', true), array('action'=>'add')); ?>
	</li>
