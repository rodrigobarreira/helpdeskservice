...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit Sla', true), array('action'=>'edit', $sla['Sla']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete Sla', true), array('action'=>'delete', $sla['Sla']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $sla['Sla']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $html->link(__('View', true), array('controller'=> 'setores', 'action'=>'view', $setor['id'])); ?>
