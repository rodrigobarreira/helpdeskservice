...
<div id="loadAjax"
	style="position: absolute; margin-left: 250px; display: none;"><?php echo $html->image('LoadAjax.gif');?></div>
<div class="chamados form"><?php 
//pr($problemas);
...
$ajax->form(array('type' => 'post',
    'options' => array(
        ...
        'url' => array(
            ...
            ?>
<fieldset><legend>Formulário de abertura de Chamado</legend> <?php
