...
?>
	<tr  <?php echo $class;?> >
		<td	>
		<?php echo $html->link($chamado['Chamado']['id'], array('controller'=>'home', 'action' => 'visualizarChamado', $chamado['Chamado']['id'])); ?>
		...
		<td	>
		<?php echo $html->link('Visualizar', array('controller'=>'home', 'action' => 'visualizarChamado', $chamado['Chamado']['id'])); ?>
		</td>
