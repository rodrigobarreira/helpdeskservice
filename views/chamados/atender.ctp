<div class="chamados form"><?php //pr($solicitante);
//echo  '/atendimento/atenderChamado/'.$chamado['Chamado']['id'];?> <?php echo $form->create('Chamado', array(
		'url'=> '/atendimento/atenderChamado/'.$chamado['Chamado']['id'],

));?>
<fieldset><legend><?php __('Atender Chamado');?></legend>
<fieldset><legend><?php __('Dados do Solicitante');?></lSolicitanteSolicitanteegend>
<?php
...
echo $form->input('Usuario.setor_id', array(
				...
				?></fieldset>
<fieldset><legend><?php __('Dados do Chamado');?></legend> <?php
echo $form->input('id', array(
				...
				?></fieldset>
<fieldset><legend><?php __('Assentamento');?></legend> <?php 
...
//'readonly' => 'readonly',
				...
				?></fieldset>
<fieldset><?php echo $form->end('Confirmar');?>
