...
<fieldset><legend><?php __('Dados do Solicitante');?> <?php  
...
<fieldset><legend> Dados do Chamado </legend> <?php
...
echo $form->input('chamado_id', array (
			...
			'type' => 'text',
			'value' => $chamado['VwChamado']['chamado_status_descricao'],
			'label' => 'Status:',
			'div' => 'campoBloqueado',
			'readonly' => 'readonly',
			'style' => 'width: 160px;',
			...
			/*if ($chamado['VwChamado']['chamado_status_id'] == 4){
				// igual a encerrada
				echo $form->input('chamado_encerramento', array(
			'type' => 'text',
			'label' => 'Data de Encerramento',
			'style' => 'width: 195px;',
			'value' => $chamado['VwChamado']['chamado_encerramento'],
			'div' => 'campoBloqueado',
			'readonly' => 'readonly'
			));
...
<div class="campoBloqueado"><label>Histórico do Chamado</label> <?php
if (count($historicos) > 0){
	?>
<table cellpadding="0" cellspacing="0"
	style="margin-left: 0px; width: 630px;">
	<?php
	$i =0;
