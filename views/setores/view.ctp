...
<?php $i = 0; $class = ' class="altrow"';?>
	...
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $setor['Setor']['id']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Descricao'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $setor['Setor']['descricao']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Sla'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $html->link($setor['Sla']['id'], array('controller'=> 'slas', 'action'=>'view', $setor['Sla']['id'])); ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Atende Chamado'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $setor['Setor']['atende_chamado']; ?>
	&nbsp;</dd>
</dl>
</div>
<div class="actions">
<ul>
	<li><?php echo $html->link(__('Edit Setor', true), array('action'=>'edit', $setor['Setor']['id'])); ?>
	</li>
	<li><?php echo $html->link(__('Delete Setor', true), array('action'=>'delete', $setor['Setor']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $setor['Setor']['id'])); ?>
	</li>
	<li><?php echo $html->link(__('List Setores', true), array('action'=>'index')); ?>
	</li>
	<li><?php echo $html->link(__('New Setor', true), array('action'=>'add')); ?>
	</li>
	<li><?php echo $html->link(__('List Slas', true), array('controller'=> 'slas', 'action'=>'index')); ?>
	</li>
	<li><?php echo $html->link(__('New Sla', true), array('controller'=> 'slas', 'action'=>'add')); ?>
	</li>
	...
	<li><?php echo $html->link(__('List Usuarios', true), array('controller'=> 'usuarios', 'action'=>'index')); ?>
	</li>
	<li><?php echo $html->link(__('New Usuario', true), array('controller'=> 'usuarios', 'action'=>'add')); ?>
	</li>
</ul>
</div>
<div class="related">
...
<table cellpadding="0" cellspacing="0">
	...
	<tr <?php echo $class;?>>
		...
		<td class="actions"><?php echo $html->link(__('View', true), array('controller'=> 'usuarios', 'action'=>'view', $usuario['id'])); ?>
