...
<table cellpadding="0" cellspacing="0">
	...
	?>
	<tr <?php echo $class;?>>
		<td><?php echo $avaliacao['Avaliacao']['id']; ?></td>
		<td><?php echo $avaliacao['Avaliacao']['data_hora']; ?></td>
		<td><?php echo $avaliacao['Avaliacao']['nivel']; ?></td>
		<td><?php echo $html->link($avaliacao['Chamado']['id'], array('controller'=> 'chamados', 'action'=>'view', $avaliacao['Chamado']['id'])); ?>
		</td>
		<td class="actions"><?php echo $html->link(__('View', true), array('action'=>'view', $avaliacao['Avaliacao']['id'])); ?>
