...
<table cellpadding="0" cellspacing="0">
	...
	<tr <?php echo $class;?>>
		...
		<td><?php echo $prioridade['Prioridade']['tempo']; ?></td>
		<td><?php echo $prioridade['Prioridade']['descricao']; ?></td>
		<td class="actions"><?php echo $html->link(__('View', true), array('action'=>'view', $prioridade['Prioridade']['id'])); ?>
