...
<table cellpadding="0" cellspacing="0">
	...
	<tr <?php echo $class;?>>
		...
		<td><?php echo $problema['Problema']['descricao']; ?></td>
		<td><?php echo $html->link($problema['Sla']['id'], array('controller'=> 'slas', 'action'=>'view', $problema['Sla']['id'])); ?>
		</td>
		<td><?php echo $html->link($problema['Setor']['id'], array('controller'=> 'setores', 'action'=>'view', $problema['Setor']['id'])); ?>
		</td>
		<td class="actions"><?php echo $html->link(__('View', true), array('action'=>'view', $problema['Problema']['id'])); ?>
