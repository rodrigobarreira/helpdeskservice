<div class="subProblemas index">
<h2><?php __('SubProblemas');?></h2>
<p>
<?php
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action'=>'view', $subProblema['SubProblema']['id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action'=>'edit', $subProblema['SubProblema']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action'=>'delete', $subProblema['SubProblema']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $subProblema['SubProblema']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
