...
<div id="usuarios"><span style="margin-left: 10px;"> <?php echo $html->link(__('Cadastrar', true), array('controller' => 'admin', 'action'=>'usuarios/cadastrar')); ?>
